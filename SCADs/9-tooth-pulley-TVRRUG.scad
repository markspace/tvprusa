...
teeth = 9;			// Number of teeth, standard Mendel T5 belt = 8, gives Outside Diameter of 11.88mm
...
m3_nut_flats = 5.6;	// normal M3 hex nut exact width = 5.5
...
nut_shaft_distance = 0.86;	// distance between inner face of nut and shaft, can be negative.
...
module T5()
	{
	linear_extrude(height=pulley_t_ht+2) polygon([
[-1.632126,-0.5],[-1.632126,0],

//[-1.568549,0.004939],[-1.507539,0.019367],
//[-1.450023,0.042686],

[-1.396912,0.074224],

//[-1.349125,0.113379],[-1.307581,0.159508],
//[-1.273186,0.211991],
...
//[-0.983414,0.978433],
//[-0.949018,1.030788],[-0.907524,1.076798],
[-0.859829,1.115847],
//[-0.80682,1.147314],
//[-0.749402,1.170562],[-0.688471,1.184956],

[-0.624921,1.189895],

[0.624971,1.189895],

//[0.688622,1.184956],[0.749607,1.170562],[0.807043,1.147314],
[0.860055,1.115847],
//[0.907754,1.076798],[0.949269,1.030788],[0.9837,0.978433],
[1.010193,0.920362],

[1.246907,0.270192],
//[1.273295,0.211991],[1.307726,0.159508],[1.349276,0.113379],
[1.397039,0.074224],
